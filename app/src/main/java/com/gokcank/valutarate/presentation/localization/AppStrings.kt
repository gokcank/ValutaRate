...
val enStrings = AppStrings(
    ...
    about = "About",
    developer = "Developer",
    tcmbRatesHeader = "Indicative TCMB Rates determined at {time} on {date}",
    errorLoading = "Error loading data",
    reportBug = "Report Bug",
    bugReportSubject = "VALUTA RATE BUG REPORT",
    appVersionLabel = "Valuta Rate v1.2.1",
    buying = "Buy",
    selling = "Sell",
...
val trStrings = AppStrings(
    ...
    tcmbRatesHeader = "{date} Tarihinde Saat {time}'da Belirlenen Gösterge Niteliğindeki TCMB Kurları",
    errorLoading = "Kurlar yüklenirken hata oluştu",
    reportBug = "Hata Bildir",
    bugReportSubject = "DÖVİZ ÇEVİRİCİ - VALUTA RATE HATA BİLDİRİMİ",
    appVersionLabel = "Döviz Çevirici - Valuta Rate v1.2.1",
    buying = "Alış",
    selling = "Satış",
...
val deStrings = AppStrings(
    ...
    tcmbRatesHeader = "Indikative TCMB-Kurse, ermittelt um {time} Uhr am {date}",
...
val frStrings = AppStrings(
    ...
    tcmbRatesHeader = "Taux indicatifs de la TCMB déterminés à {time} le {date}",
